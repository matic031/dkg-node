...
import pluginMedsy from "../dist/index.js";
import {
  createExpressApp,
...
describe("@dkg/plugin-medsy checks", function () {
  ...
  beforeEach(async () => {
    ...
    // Initialize plugin
    pluginMedsy(mockDkgContext, mockMcpServer, apiRouter);
    await connect();
    app.use("/", apiRouter);
  });
  ...
  describe("Plugin Configuration", () => {
    it("should create plugin without errors", () => {
      expect(pluginMedsy).to.be.a("function");
    });
  });
